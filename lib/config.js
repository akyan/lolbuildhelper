...
{
    console.log('Unable to find riotapitconfig, will carry on assuming key is available via env variable');
}

exports.riotApiConfig.devkey = process.env.RIOT_API_KEY || exports.riotApiConfig.devkey;
